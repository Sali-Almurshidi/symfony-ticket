 ...
 */
final class Version20200324010516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT FK_97A0ADA3F8697D13 FOREIGN KEY (comment_id) REFERENCES comment (id)');
